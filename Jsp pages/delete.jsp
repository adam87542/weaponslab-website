...
if(request.getParameter("send")!=null)
{
	...
	//יצירת קשר למסד הנתונים 
	   try
	   {
			...
			con=java.sql.DriverManager.getConnection("jdbc:mysql://127.0.0.1:3306/DBADAM","root",""); // התחברות למסד נתונים
	   ...
	   if(userFound)  //משתמש קיים
	   {
		   ...
		   response.sendRedirect("doDelete.jsp"); //הפניה לביצוע הביטול
	   }
