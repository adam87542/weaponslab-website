...
<div style="text-align:center">
 ...
 <form id="theForm" action="doUpdateByDetails.jsp">
  <table>
   <tr>
      <td> username  </td>
   ...
   <tr>
      <td>  favorite time period </td>
      <th> <input type="text" size="10" name="time_period" value=<%=session.getAttribute("time_period")%>></th>
   </tr>
   <tr>
      <td> Favorite weapon </td>
       <th> <input type="text" size="10" name="favorite_weapon" value=<%=session.getAttribute("favorite_weapon")%>></th>
   </tr>
   <tr>
...
if(request.getParameter("send")!=null)
	...
	//����� ��� ���� ������� 
	   try
		...
		String sql="UPDATE TBUSERS SET username='"+username+"',password='"+password+"',email='"+email+"',time_period='"+time_period+"',special_weapon='" +special_weapon+ "' WHERE username='"+username+"' and password='"+password+"' ";	
		try
		{
